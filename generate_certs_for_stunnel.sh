...
CA_DIR="./mc/certgen/stunnel_certs/ca"
SERVER_DIR="./mc/certgen/stunnel_certs/server"
CLIENT_DIR="./mc/certgen/stunnel_certs/client"
...
openssl req -new -key "$SERVER_KEY" -out "$SERVER_CERT" -subj "/CN=${CHANNEL_NAME}_server"
...
openssl req -new -key "$CLIENT_KEY" -out "$CLIENT_CERT" -subj "/CN=${CHANNEL_NAME}_client"
